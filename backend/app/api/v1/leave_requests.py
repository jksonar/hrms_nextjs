...
@router.post("/", response_model=LeaveRequest, status_code=status.HTTP_201_CREATED, dependencies=[Depends(role_required([UserRole.EMPLOYEE]))])
...
@router.get("/", response_model=List[LeaveRequest], dependencies=[Depends(role_required([UserRole.ADMIN, UserRole.HR, UserRole.MANAGER]))])
...
@router.get("/employee/{employee_id}", response_model=List[LeaveRequest], dependencies=[Depends(role_required([UserRole.ADMIN, UserRole.HR, UserRole.MANAGER]))])
...
@router.get("/{leave_request_id}", response_model=LeaveRequest, dependencies=[Depends(role_required([UserRole.ADMIN, UserRole.HR, UserRole.MANAGER, UserRole.EMPLOYEE]))])
...
@router.put("/{leave_request_id}", response_model=LeaveRequest, dependencies=[Depends(role_required([UserRole.ADMIN, UserRole.HR, UserRole.MANAGER]))])
...
@router.post("/{leave_request_id}/approve", dependencies=[Depends(role_required([UserRole.ADMIN, UserRole.HR, UserRole.MANAGER]))])
...
@router.post("/{leave_request_id}/reject", dependencies=[Depends(role_required([UserRole.ADMIN, UserRole.HR, UserRole.MANAGER]))])
...
@router.get("/my-requests", response_model=List[LeaveRequest], dependencies=[Depends(role_required([UserRole.EMPLOYEE]))])
...
@router.get("/pending-approvals", response_model=List[LeaveRequest], dependencies=[Depends(role_required([UserRole.MANAGER]))])
